...
class Instructor(models.Model):
    ...
    def __str__(self):
        ...
        if self.disambiguator == '':
            ...
            result = '%s, %s (%s)' % (self.last_name, self.first_name)
        return result
...
class Registration(models.Model):
    ...
    student = models.ForeignKey(Student, related_name='sections', on_delete=models.PROTECT)
    section = models.ForeignKey(Section, related_name='sections', on_delete=models.PROTECT)
